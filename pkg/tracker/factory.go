...
func createTracker(name string, logger log.Logger, config *config.Config, db db.DataServerProxy, client contracts.ETHClient, contract *contracts.Tellor, accounts []*rpc.Account) ([]Tracker, error) {
	switch name {
	case "balance":
		{
