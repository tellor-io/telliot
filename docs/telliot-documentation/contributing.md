...
* Familiarizing yourself with the [Makefile](https://github.com/tellor-io/telliot/tree/4966df1aa2b5d708021839485dfbbc3dff7e0021/Makefile/README.md) commands, for example, `build`, `format`, `test`, `lint`.
...
The project uses [Bingo](https://github.com/tellor-io/telliot/tree/4966df1aa2b5d708021839485dfbbc3dff7e0021/.bingo/README.md) for adding any go tools required by the project.
