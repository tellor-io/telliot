...
* Familiarizing yourself with the [Makefile](https://github.com/tellor-io/telliot/tree/4b4e37cbbd76473f59261ae9790918446cc5114c/Makefile/README.md) commands, for example, `build`, `format`, `test`, `lint`.
...
The project uses [Bingo](https://github.com/tellor-io/telliot/tree/4b4e37cbbd76473f59261ae9790918446cc5114c/.bingo/README.md) for adding any go tools required by the project.
