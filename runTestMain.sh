...
go run . -psrPath="${PSR}" -config="${CFG6}" -logConfig="${LOG}" "$@" nohup &
go run . -psrPath="${PSR}" -config="${CFG1}" -logConfig="${LOG}" "$@" nohup &
go run . -psrPath="${PSR}" -config="${CFG2}" -logConfig="${LOG}" "$@" nohup &
go run . -psrPath="${PSR}" -config="${CFG3}" -logConfig="${LOG}" "$@" nohup &
go run . -psrPath="${PSR}" -config="${CFG4}" -logConfig="${LOG}" "$@" nohup &
go run . -psrPath="${PSR}" -config="${CFG5}" -logConfig="${LOG}" "$@" nohup 
